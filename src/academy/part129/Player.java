...
//    PLAYLIST METHODS
    ...
    public boolean addSongToPlaylist() {
        ...
        Song song = album.getSongs().findSong(songTitle);
        if (song == null) {
    ...
    public boolean createAlbum() {
        ...
        System.out.println("Album " + albumTitle + " has been created");
    ...
    public boolean addSongToAlbum() {
        ...
        Album.SongList songs = album.getSongs();
        System.out.println("Enter the song title");
        String songTitle = scanner.next();
        ...
        System.out.println("Enter the song duration");
        double songDuration = scanner.nextDouble();
        album.getSongs().addSong(songTitle, songDuration);
    ...
    public boolean printSongList() {
        ...
        System.out.println("Album size is " + album.getSongs().getSongList().size());
